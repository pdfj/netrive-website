...
const PROJECT_IMAGES = [
  "/images/portfolio/pacome-pertant.png",
  "/images/portfolio/noomo-storytelling.jpg",
  "/images/portfolio/sohub.png",
  "/images/portfolio/seoulglow.jpg",
];
  ...
  return (
    <section className="relative mx-auto max-w-content px-6 py-24 sm:py-32">
      <SectionHeading
        ...
        subtitle="Real websites. Real results. Click any project to explore it live."
      />
        ...
        {PORTFOLIO.map((project, i) => (
          ...
          >
            <a
              ...
              className="group block cursor-pointer rounded-[24px] glass p-3 transition-all duration-300 hover:scale-[1.02] hover:border-sky/25 hover:shadow-glow"
            >
              {/* Browser chrome */}
              <div className="overflow-hidden rounded-card border border-white/10 bg-night">
                <div className="flex items-center gap-1.5 border-b border-white/10 bg-white/[0.03] px-4 py-3">
                  ...
                  <span className="ml-3 flex h-4 flex-1 items-center rounded-full bg-white/[0.04] px-2.5 text-[9px] text-white/30">
                    {project.domain}
                  </span>
                </div>
              ...
              <div className="px-3 pb-3 pt-5">
                ...
                <h3 className="mt-4 flex items-center gap-2 font-display text-2xl font-medium text-white">
                  {project.name}
                  <ArrowUpRight className="h-5 w-5 text-sky opacity-0 transition-all duration-200 group-hover:translate-x-0.5 group-hover:opacity-100" />
                </h3>
