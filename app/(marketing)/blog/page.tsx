...
const CATEGORY_COLORS: Record<string, string> = {
  Strategy: "from-[#00d4ff] to-[#7C3AED]",
      ...
      <main className="pt-20">
        ...
        <div className="relative overflow-hidden">
          <div
            ...
            style={{
              background:
                "radial-gradient(ellipse 80% 80% at 50% 0%, rgba(99,102,241,0.2) 0%, transparent 70%)",
            }}
            aria-hidden
          />
        ...
        <section className="mx-auto max-w-content px-6 pb-32">
          {BLOG_POSTS.length === 0 ? (
            ...
            <div className="grid grid-cols-1 gap-7 sm:grid-cols-2 lg:grid-cols-3">
              {BLOG_POSTS.map((post) => {
                const color = CATEGORY_COLORS[post.category] ?? "from-[#00d4ff] to-[#7C3AED]";
                return (
                  <article
                    key={post.title}
